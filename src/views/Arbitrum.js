        ...
        <div className="chart-cell">
          ...
          >
            ...
            <div className="chart-description">
              <p>
                <span style={{color: COLORS[0]}}>% of Index (with fees)</span> is Mlp with fees / Index Price * 100. Index is a basket of 25% BTC, 25% ETH, 50% USDC rebalanced once&nbsp;a&nbsp;day
                <br/>
                <span style={{color: COLORS[4]}}>% of LP ETH-USDC (with fees)</span> is Mlp Price with fees / LP ETH-USDC * 100<br/>
              </p>
            </div>
          </ChartWrapper>
        </div>
          ...
          >
            <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
              <LineChart data={glpPerformanceData} syncId="syncGlp">
                ...
                <Line isAnimationActive={false} type="monotone" unit="$" strokeWidth={1} dot={false} dataKey="glpPrice" name="Mlp Price" stroke={COLORS[1]} />
                <Line isAnimationActive={false} type="monotone" unit="$" strokeWidth={2} dot={false} dataKey="glpPlusFees" name="Mlp w/ fees" stroke={COLORS[3]} />
            ...
            <div className="chart-description">
              <p>
                <span style={{color: COLORS[3]}}>Mlp with fees</span> is based on ALP share of fees received and excluding esMMX rewards<br/>
