  ...
  return (
    <div className="Home">
      ...
      <div className="chart-grid">
        ...
        <div className="chart-cell">
          <ChartWrapper title="AUM & Alp Supply" loading={glpLoading} data={glpData} csvFields={[{ key: 'aum' }, { key: 'glpSupply' }]}>
            <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
              <LineChart data={glpData} syncId="syncGlp">
                ...
                <Line isAnimationActive={false} type="monotone" strokeWidth={2} dot={false} dataKey="glpSupply" stackId="a" name="Alp Supply" stroke={COLORS[1]} />
              </LineChart>
            </ResponsiveContainer>
          </ChartWrapper>
        </div>
        ...
        <div className="chart-cell">
          ...
          >
            ...
            <div className="chart-description">
              <p>
                <span style={{color: COLORS[0]}}>% of Index</span> is Alp with fees / Index Price * 100. Index is a basket 16.6% AVAX, 16.6% BTC, 16.6% ETH and 50% USDC rebalanced once&nbsp;a&nbsp;day
                  <br/>
                <span style={{color: COLORS[4]}}>% of LP TOKEN-USDC</span> is Alp Price with fees / LP TOKEN-USDC * 100<br/>
              </p>
            </div>
          </ChartWrapper>
        </div>
          ...
          >
            <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
              <LineChart data={glpPerformanceData} syncId="syncGlp">
                ...
                <Line isAnimationActive={false} type="monotone" unit="$" strokeWidth={1} dot={false} dataKey="glpPrice" name="Alp Price" stroke={COLORS[1]} />
                <Line isAnimationActive={false} type="monotone" unit="$" strokeWidth={2} dot={false} dataKey="glpPlusFees" name="Alp w/ fees" stroke={COLORS[3]} />
            ...
            <div className="chart-description">
              <p>
                <span style={{color: COLORS[3]}}>Alp with fees</span> is based on ALP share of fees received and excluding esMMX rewards<br/>
