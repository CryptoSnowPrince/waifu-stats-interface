        ...
        mode && <div className={cx("App", mode)}>
          ...
          <div className="nav">
            <div className="nav-left">
              ...
              <a href="https://www.waifuai.ink/" target="_blank" className="nav-logo">
            ...
            <div className="nav-right">
              <a href="https://www.waifuai.ink/" target="_blank" className="nav-link">APP</a>
              <a href="https://docs.waifuai.world/" target="_blank" className="nav-link">DOCS</a>
